...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    {
		...
		/// <returns></returns>
		public static bool IsRabbit(BaseAi baseAi) => baseAi.Rabbit;
		...
		/// <param name="baseAi">The BaseAi instance</param>
		/// <returns></returns>
		public static bool IsBear(BaseAi baseAi) => baseAi.Bear;
        ...
        /// <param name="baseAi">The BaseAi instance</param>
        /// <returns></returns>
        public static bool IsBaseWolf(BaseAi baseAi) => baseAi.BaseWolf;
        ...
        /// <param name="baseAi">The BaseAi instance</param>
        /// <returns></returns>
        public static bool IsNormalWolf(BaseAi baseAi) => baseAi.NormalWolf;
        ...
        /// <param name="baseAi">The BaseAi instance</param>
        /// <returns></returns>
        public static bool IsTimberwolf(BaseAi baseAi) => baseAi.Timberwolf;

		/// <summary>
		/// Checks if the current BaseAi is a Toxic Wolf
		/// </summary>
		/// <param name="baseAi"></param>
		/// <returns></returns>
		public static bool IsToxicWolf(BaseAi baseAi) => baseAi.StarvingWolf;
		...
		/// <param name="baseAi">The BaseAi instance</param>
		/// <returns></returns>
		public static bool IsMoose(BaseAi baseAi) => baseAi.Moose;
        ...
        /// <param name="baseAi">The BaseAi instance</param>
        /// <returns></returns>
        public static bool IsBaseDeer(BaseAi baseAi) => baseAi.BaseDeer;
        /// <summary>
        /// Checks if the current BaseAi is a Normal Stag
        /// </summary>
        /// <param name="baseAi">The BaseAi instance</param>
        /// <returns></returns>
        public static bool IsStag(BaseAi baseAi) => baseAi.Stag;
        ...
        /// <param name="baseAi">The BaseAi instance</param>
        /// <returns></returns>
        public static bool IsStagWhite(BaseAi baseAi) => baseAi.StagWhite;
        ...
        /// <param name="baseAi">The BaseAi instance</param>
        /// <returns></returns>
        public static bool IsDoe(BaseAi baseAi) => baseAi.Doe;
        ...
        /// <param name="baseAi">The BaseAi instance</param>
        /// <returns></returns>
        public static bool IsPtarmigan(BaseAi baseAi) => baseAi.Ptarmigan;
        ...
        /// <param name="baseAi">The BaseAi instance</param>
        /// <returns></returns>
        public static bool IsCougar(BaseAi baseAi) => baseAi.Cougar;

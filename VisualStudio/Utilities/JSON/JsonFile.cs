...
namespace CommonLib.Utilities.JSON
{
	/// <summary>
	/// 
	/// </summary>
	public class JsonFile
	{
		...
		/// <returns>An instance of <typeparamref name="T"/> with the data desearalized from the JSON file</returns>
		/// <exception cref="BadMemeException"></exception>
		public static T? Load<T>(string configFileName, bool createFile, JsonSerializerOptions options)
		{
		...
		/// <returns>An instance of <typeparamref name="T"/> with the data desearalized from the JSON file</returns>
		/// <exception cref="BadMemeException"></exception>
		public static async Task<T?> LoadAsync<T>(string configFileName, bool createFile, JsonSerializerOptions options)
		{
		...
		/// <param name="options">OPTIONAL: Options to use when saving the file. You MUST use the same options to load the file</param>
		/// <exception cref="BadMemeException"></exception>
		public static async Task SaveAsync<T>(string configFileName, T? Tinput, JsonSerializerOptions options)
		{
